   ...
   private class SaveAction extends AbstractAction {
      ...
      public void actionPerformed( ActionEvent e )
      {
         ...
         try {
            ...
            // Check for return type : true = OK, false = failure
            if ( personID == 0 )         
   ...
   private class SearchAction extends AbstractAction {
      ...
      public void actionPerformed( ActionEvent e )
      {
         ...
         if ( lastName != null ) {
            ...
            // Execute search. If found, (ONLY 1) AddressBookEntry
            // is returned containing data.
            // Fix by adding a while loop to create multiple entryFrames in List
            List<AddressBookEntry> people = database.findPerson(lastName);

            if ( people != null ) {
               for(AddressBookEntry a : people) {
                  ...
                  entryFrame.setAddressBookEntry( a );
