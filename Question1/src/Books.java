...
public class Books extends JFrame {
    ...
    public Books() {
        ...
        getAuthorsAction = new GetAuthorsAction();
        getPublishersAction = new GetPublishersAction();
        getTitlesAction = new GetTitlesAction();
        ...
        toolBar.add(getAuthorsAction);
        toolBar.add(getPublishersAction);
        toolBar.add(getTitlesAction);
        ...
        contentContainer.add(desktop);

        backgroundContainer.add(contentContainer, BorderLayout.CENTER);
        backgroundContainer.add(toolBar, BorderLayout.NORTH);
    ...
    private class GetAuthorsAction extends AbstractAction {
        public GetAuthorsAction() {
            putValue(NAME, "Get Authors");
            putValue(SHORT_DESCRIPTION, "Author list");
            putValue(LONG_DESCRIPTION, "Get list of authors");

        }

        public void actionPerformed(ActionEvent e) {
            if (contentContainer.getComponentCount() > 1) {
                contentContainer.remove(contentContainer.getComponent(1));
            }

            resultTable = new JTable(database.getTableModel("SELECT * FROM authors"));
            contentContainer.add(new JScrollPane(resultTable));
            revalidate();
            repaint();
        }
    }
    ...
    private class GetPublishersAction extends AbstractAction {
        public GetPublishersAction() {
            putValue(NAME, "Get Publishers");
            putValue(SHORT_DESCRIPTION, "Publisher list");
            putValue(LONG_DESCRIPTION, "Get list of publishers");
        }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            resultTable = new JTable(database.getTableModel("SELECT * FROM publishers"));
            contentContainer.add(new JScrollPane(resultTable));
            revalidate();
            repaint();
        }
    ...
    private class GetTitlesAction extends AbstractAction {
        public GetTitlesAction() {
            putValue(NAME, "Get Titles");
            putValue(SHORT_DESCRIPTION, "Title list");
            putValue(LONG_DESCRIPTION, "Get list of titles");
        }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            resultTable = new JTable(database.getTableModel("SELECT * FROM titles"));
            contentContainer.add(new JScrollPane(resultTable));
            revalidate();
            repaint();
        }
